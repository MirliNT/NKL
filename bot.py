...
async def get_link(message: Message, state: FSMContext):
    ...
    try:
        ...
        # Извлекаем ID платежа и ссылку для подтверждения
...
# ====== ФУНКЦИЯ ПРОВЕРКИ СТАТУСА ПЛАТЕЖА ЧЕРЕЗ ПРЯМОЙ ЗАПРОС ======
